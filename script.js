        ...
        next: function () {
            ...
            for (var y = 0; y < this.height; y++) {
                for (var x = 0; x < this.width; x++) {
                    ...
                    // TODO: Rae needs to implement the rules of the Game of life here :D
                    if (alive) {
                        if (neighbors < 2) {
                            this.board[y][x] = 0;
                        }
                    ...
                    // Work in between these two sections
                }
            }
        },
        ...
        createGrid: function () {
            ...
            for (var y = 0; y < this.size; y++) {
                ...
                for (var x = 0; x < this.size; x++) {
                    ...
                    checkbox.coords = [y, x];
                    checkbox.checked = Math.random() < 0.3 //30% probability of getting true
...
var lifeView = new LifeView(document.getElementById('grid'), 100);